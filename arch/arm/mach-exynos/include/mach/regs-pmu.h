...
/* Only for EXYNOS5250 */
#define EXYNOS5_GPS_LPI					EXYNOS_PMUREG(0x0004)

#define EXYNOS5_USB_CFG					EXYNOS_PMUREG(0x0230)
...
#define EXYNOS5_GPS_SYS_PWR_REG				EXYNOS_PMUREG(0x141C)
...
#define EXYNOS5_CMU_CLKSTOP_GPS_SYS_PWR_REG		EXYNOS_PMUREG(0x149C)
...
#define EXYNOS5_CMU_SYSCLK_GPS_SYS_PWR_REG		EXYNOS_PMUREG(0x14DC)
...
#define EXYNOS5_CMU_RESET_GPS_SYS_PWR_REG		EXYNOS_PMUREG(0x159C)
...
#define EXYNOS5_GPS_OPTION				EXYNOS_PMUREG(0x40E8)
