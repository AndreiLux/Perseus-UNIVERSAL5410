...
#define GPIO_SROMC_CSN		EXYNOS5410_GPY0(0)
#define GPIO_SROMC_CSN0		EXYNOS5410_GPY0(0)
#define GPIO_SROMC_CSN1		EXYNOS5410_GPY0(1)
#define GPIO_SROMC_CSN2		EXYNOS5410_GPY0(2)
#define GPIO_SROMC_CSN3		EXYNOS5410_GPY0(3)
#define GPIO_SROMC_REN		EXYNOS5410_GPY0(4)
#define GPIO_SROMC_WEN		EXYNOS5410_GPY0(5)
#define GPIO_SROMC_LBN		EXYNOS5410_GPY1(0)
#define GPIO_SROMC_UBN		EXYNOS5410_GPY1(1)
#define GPIO_SROMC_ADDR_BUS_L	EXYNOS5410_GPY3(0)
#define GPIO_SROMC_ADDR_BUS_H	EXYNOS5410_GPY4(0)
#define GPIO_SROMC_DATA_BUS_L	EXYNOS5410_GPY5(0)
#define GPIO_SROMC_DATA_BUS_H	EXYNOS5410_GPY6(0)
...
static int sromc_config_demux_gpio(struct sromc_bus_cfg *bc)
{
	...
	case 0:
		break;
	case 1 ... EXYNOS5410_GPIO_Y3_NR:
		bits = addr_bits;
		s3c_gpio_cfgrange_nopull(GPIO_SROMC_ADDR_BUS_L, bits, sfn);
		break;

	case (EXYNOS5410_GPIO_Y3_NR + 1) ... 16:
		bits = EXYNOS5410_GPIO_Y3_NR;
		s3c_gpio_cfgrange_nopull(GPIO_SROMC_ADDR_BUS_L, bits, sfn);
		bits = (addr_bits - EXYNOS5410_GPIO_Y3_NR);
