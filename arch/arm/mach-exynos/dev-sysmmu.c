...
SYSMMU_PLATFORM_DEVICE(jpeg,	1);
SYSMMU_PLATFORM_DEVICE(fimd1,	2);
SYSMMU_PLATFORM_DEVICE(2d,	3);
SYSMMU_PLATFORM_DEVICE(rot,	4);
SYSMMU_PLATFORM_DEVICE(mdma,	5);
SYSMMU_PLATFORM_DEVICE(tv,	6);
SYSMMU_PLATFORM_DEVICE(mfc_l,	7);
SYSMMU_PLATFORM_DEVICE(mfc_r,	8);
SYSMMU_PLATFORM_DEVICE(is_isp,	9);
SYSMMU_PLATFORM_DEVICE(is_drc,	10);
SYSMMU_PLATFORM_DEVICE(is_fd,	11);
SYSMMU_PLATFORM_DEVICE(is_cpu,	12);
SYSMMU_PLATFORM_DEVICE(is_sclrc, 13);
SYSMMU_PLATFORM_DEVICE(is_sclrp, 14);
SYSMMU_PLATFORM_DEVICE(is_odc,	15);
SYSMMU_PLATFORM_DEVICE(is_dis0,	16);
SYSMMU_PLATFORM_DEVICE(is_dis1,	17);
SYSMMU_PLATFORM_DEVICE(is_3dnr,	18);
SYSMMU_PLATFORM_DEVICE(flite0,	20);
SYSMMU_PLATFORM_DEVICE(flite1,	21);
SYSMMU_PLATFORM_DEVICE(gsc0,	25);
SYSMMU_PLATFORM_DEVICE(gsc1,	26);
SYSMMU_PLATFORM_DEVICE(gsc2,	27);
SYSMMU_PLATFORM_DEVICE(gsc3,	28);
