...
static struct bts_info exynos5_bts[] = {
	...
	[BTS_IDX_MFC0] = {
		...
		.table[BS_MIF400_MFC].table_list = p2_table,
		.table[BS_MIF400_MFC].table_num = ARRAY_SIZE(p2_table),
		.table[BS_MIF400_MFC_G3D].table_list = p2_table,
		.table[BS_MIF400_MFC_G3D].table_num = ARRAY_SIZE(p2_table),
		.table[BS_MIF400_MFC_GSCL].table_list = p2_table,
		.table[BS_MIF400_MFC_GSCL].table_num = ARRAY_SIZE(p2_table),
		.table[BS_MIF400_MFC_GSCL_G3D].table_list = p2_table,
		.table[BS_MIF400_MFC_GSCL_G3D].table_num = ARRAY_SIZE(p2_table),
	...
	[BTS_IDX_G3D0] = {
		...
		.table[BS_MIF400_G3D_W1].table_list = p2_table,
		.table[BS_MIF400_G3D_W1].table_num = ARRAY_SIZE(p2_table),
