...
static void exynos_ppmu_reset(struct exynos_ppmu_hw *ppmu)
{
...
static void exynos_ppmu_setevent(struct exynos_ppmu_hw *ppmu,
...
static void exynos_ppmu_start(struct exynos_ppmu_hw *ppmu)
{
	void __iomem *ppmu_base = ppmu->hw_base;
	__raw_writel(0x1, ppmu_base);
}

static void exynos_ppmu_stop(struct exynos_ppmu_hw *ppmu)
{
	void __iomem *ppmu_base = ppmu->hw_base;
