...
#endif
#define GPIO_TSP_INT EXYNOS5410_GPJ0(0)		/* GPIO_TSP_INT */
#define GPIO_TSP_SCL_18V EXYNOS5410_GPB3(1)	/* GPIO_TSP_SCL_18V */
#define GPIO_TSP_SDA_18V EXYNOS5410_GPB3(0)	/* GPIO_TSP_SDA_18V */
...
void midas_tsp_set_platdata(struct mxt224_platform_data *pdata)
{
	...
	i2c_devs0[0].platform_data = pdata;
}
#endif
...
void __init midas_tsp_init(void)
{
	...
	i2c_devs0[0].irq = gpio_to_irq(gpio);

	printk(KERN_INFO "%s touch : %d\n", __func__, i2c_devs0[0].irq);
#endif
