...
struct omap_volt_data omap54xx_vdd_mpu_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP5430_VDD_MPU_OPP_LOW, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0xf4, 0x0c),
	VOLT_DATA_DEFINE(OMAP5430_VDD_MPU_OPP_NOM, OMAP44XX_CONTROL_FUSE_MPU_OPP100, 0xf9, 0x16),
	VOLT_DATA_DEFINE(OMAP5430_VDD_MPU_OPP_HIGH, OMAP44XX_CONTROL_FUSE_MPU_OPPTURBO, 0xfa, 0x23),
	VOLT_DATA_DEFINE(OMAP5430_VDD_MPU_OPP_SB, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27),
...
struct omap_volt_data omap54xx_vdd_mm_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP5430_VDD_MM_OPP_LOW, OMAP44XX_CONTROL_FUSE_IVA_OPP50, 0xf4, 0x0c),
	VOLT_DATA_DEFINE(OMAP5430_VDD_MM_OPP_NOM, OMAP44XX_CONTROL_FUSE_IVA_OPP100, 0xf9, 0x16),
	VOLT_DATA_DEFINE(OMAP5430_VDD_MM_OPP_OD, OMAP44XX_CONTROL_FUSE_IVA_OPPTURBO, 0xfa, 0x23),
	VOLT_DATA_DEFINE(0, 0, 0, 0),
};
...
struct omap_volt_data omap54xx_vdd_core_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP5430_VDD_CORE_OPP_LOW, OMAP44XX_CONTROL_FUSE_CORE_OPP50, 0xf4, 0x0c),
	VOLT_DATA_DEFINE(OMAP5430_VDD_CORE_OPP_NOM, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0xf9, 0x16),
	VOLT_DATA_DEFINE(0, 0, 0, 0),
};
