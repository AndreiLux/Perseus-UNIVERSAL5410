...
unsigned int Firmware_version_of_file = 0x52B;
unsigned char *firmware_name = "epen/W9002_B781.bin";

char Firmware_checksum[] = { 0x1F, 0x53, 0x1C, 0xB3, 0x8B, };
#elif defined(CONFIG_MACH_V1)
const unsigned int Binary_nLength = 0x0000;
const unsigned char Mpu_type = 0x00;
unsigned int Firmware_version_of_file = 0x0053;
unsigned char *firmware_name = "epen/W9007_B878.bin";

char Firmware_checksum[] = { 0x1F, 0xA9, 0x12, 0x8F, 0x52, };
const char B804_checksum[] = { 0x1F, 0x53, 0x1C, 0xB3, 0x8B, };
#endif
...
void wacom_i2c_init_firm_data(void)
{
	...
	if (type == EPEN_DTYPE_B878) {
		...
		firmware_name = "epen/W9007_B804.bin";
		Firmware_version_of_file = 0x0007;
		memcpy(Firmware_checksum, B804_checksum,
			sizeof(Firmware_checksum));
	}
#endif
}
