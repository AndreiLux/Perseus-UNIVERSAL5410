...
static void set_c2c_device(struct platform_device *pdev)
{
	...
	c2c_con.pmu_retention = pdata->pmu_retention;
	c2c_con.c2c_ddrphy_dlllock = pdata->c2c_ddrphy_dlllock;
	c2c_con.c2c_state_reg = pdata->c2c_state_reg;
...
int c2c_resume(void)
{
	...
	udelay(100);
	writel(0x1, c2c_con.c2c_ddrphy_dlllock);
