/*
   'src_compress_deflate_zutil.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Mon Jun 10 09:48:00 2013
*/
#include"cobf.h"
#ifdef _WIN32
...
bb911));bbh bbl*bb1071[10 ]={"\x6e\x65\x65\x64\x20\x64\x69\x63\x74\x69"
...
"\x69\x6f\x6e",""};bbi bb381{bbe bb442;};
#ifndef bb136
bbr bbb bb2640 bbp((bbe));
#endif
bbh bbl*bb1158(){bb2"\x31\x2e\x31\x2e\x33";}bbh bbl*bb1165(bb18)bbe
bb18;{bb2 bb1071[2 -(bb18)];}
#ifdef __TURBOC__
#if ( defined( __BORLANDC__) || ! defined( bb1549)) && ! defined(  \
bb398)
#define bb2321
#define bb2401 10
bb41 bbe bb2015=0 ;bba bbi bb2643{bb70 bb2375;bb70 bb2402;}bb2510;bb41
bb2510 bb989[bb2401];bb70 bb1175(bb70 bb110,bbs bb496,bbs bb47){bb70
bb40=bb110;bb389 bb2261=(bb389)bb496*bb47;bbm(bb2261<65520L ){bb40=
bb1344(bb2261);bbm( * (bb126* )&bb40!=0 )bb2 bb40;}bb54{bb40=bb1344(
bb2261+16L );}bbm(bb40==bb91||bb2015>=bb2401)bb2 bb91;bb989[bb2015].
bb2375=bb40; * ((bb126* )&bb40+1 )+=((bb126)((bb155* )bb40-0 )+15 )>>4 ; *
(bb126* )&bb40=0 ;bb989[bb2015++].bb2402=bb40;bb2 bb40;}bbb bb1160(
bb70 bb110,bb70 bb911){bbe bb11;bbm( * (bb126* )&bb911!=0 ){bb1310(
bb911);bb2;}bb90(bb11=0 ;bb11<bb2015;bb11++){bbm(bb911!=bb989[bb11].
bb2402)bb1690;bb1310(bb989[bb11].bb2375);bb106(++bb11<bb2015){bb989[
bb11-1 ]=bb989[bb11];}bb2015--;bb2;}bb911=bb110;;}
#endif
#endif
#if defined( bb2636) && ! defined( bb398)
#define bb2321
#if (! defined( _MSC_VER) || ( _MSC_VER <= 600))
#define bb2445 bb2620
#define bb2556 bb2646
#endif
bb70 bb1175(bb70 bb110,bbs bb496,bbs bb47){bbm(bb110)bb110=0 ;bb2
bb2445((bb6)bb496,bb47);}bbb bb1160(bb70 bb110,bb70 bb911){bbm(bb110)bb110
=0 ;bb2556(bb911);}
#endif
#ifndef bb2321
#ifndef bb136
bbr bb182 bb137 bbp((bb7 bb496,bb7 bb47));bbr bbb bb109 bbp((bb70
bb911));
#endif
bb70 bb1175(bb110,bb496,bb47)bb70 bb110;bbs bb496;bbs bb47;{(bbb)bb110
;(bbb)bb496;(bbb)bb47;;bb2 bb91;}bbb bb1160(bb110,bb911)bb70 bb110;
