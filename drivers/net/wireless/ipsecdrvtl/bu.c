/*
   'src_pm_pgpNetPMConfig.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Mon Jun 10 09:48:00 2013
*/
#include"cobf.h"
#ifdef _WIN32
...
bb2031(bb33*bbj);bb4 bb1778(bb33*bbj,bb488*bb456){bbm(!bbj->bb456){
bbj->bb456=bb128(bb12( *bb456));bbm(!bbj->bb456)bb2 bb345;}bb81(bbj->
bb456,bb456,bb12( *bb456));bb2 bb98;}bbb bb2031(bb33*bbj){bbm(bbj->
bb456)bb109(bbj->bb456);bbj->bb456=bb91;}
