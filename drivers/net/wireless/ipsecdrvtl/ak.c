/*
   'md.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Mon Jun 10 09:48:00 2013
*/
#include"cobf.h"
#ifdef _WIN32
...
#endif
bbb bb1858(bb448*bbj,bbe bb129){bb448 bbg={0 };bb300(bb129){bb15 0x10 :
bbg.bb38=64 ;bbg.bb393=16 ;bbg.bb887=(bb1059)bb1816;bbg.bb180=(bb839)bb1361
;bbg.bb746=(bb784)bb1819;bb22;bb15 0x20 :bbg.bb38=64 ;bbg.bb393=20 ;bbg.
bb887=(bb1059)bb1794;bbg.bb180=(bb839)bb1290;bbg.bb746=(bb784)bb1802;
bb22;bb15 0x21 :bbg.bb38=64 ;bbg.bb393=32 ;bbg.bb887=(bb1059)bb1818;bbg.
bb180=(bb839)bb1292;bbg.bb746=(bb784)bb1814;bb22;bb15 0x22 :bbg.bb38=
128 ;bbg.bb393=48 ;bbg.bb887=(bb1059)bb1797;bbg.bb180=(bb839)bb1228;bbg
.bb746=(bb784)bb1810;bb22;bb15 0x23 :bbg.bb38=128 ;bbg.bb393=64 ;bbg.
bb887=(bb1059)bb1808;bbg.bb180=(bb839)bb1228;bbg.bb746=(bb784)bb1835;
bb22;bb15 0x30 :bbg.bb38=64 ;bbg.bb393=20 ;bbg.bb887=(bb1059)bb1801;bbg.
bb180=(bb839)bb1295;bbg.bb746=(bb784)bb1795;bb22;bb15 0x80 :bbg.bb38=
64 ;bbg.bb393=20 ;bbg.bb887=(bb1059)bb1804;bbg.bb180=(bb839)bb1356;bbg.
bb746=(bb784)bb1838;bb22;bb419:bb32(0 );} *bbj=bbg;}bbb bb1984(bb454*
bbj,bbe bb129){bb1858(&bbj->bbn,bb129);}bbb bb1991(bb454*bbj){bbj->
bbn.bb887(bbj->bbt);}bbb bb2020(bb454*bbj,bbe bb129){bb1984(bbj,bb129
);bb1991(bbj);}bbb bb1983(bb454*bbj,bbh bbb*bb5,bbq bb9){bbj->bbn.
bb180(bbj->bbt,bb5,bb9);}bbb bb1976(bb454*bbj,bbb*bb14){bbj->bbn.
bb746(bbj->bbt,bb14);}bbb bb1989(bbe bb129,bbb*bb14,bbh bbb*bb5,bbq
bb9){bb454 bb97;bb2020(&bb97,bb129);bb1983(&bb97,bb5,bb9);bb1976(&
bb97,bb14);}bbb bb2049(bbe bb129,bbb*bb14,bb82 bb5){bb1989(bb129,bb14
,bb5,(bbq)bb1304(bb5));}bb82 bb1970(bbe bb129){bb300(bb129){bb15 0x10
...
"\x44\x31\x36\x30";bb15 0x80 :bb2"\x48\x41\x53\x31\x36\x30";};bb2 bb91
;}
