/*
   'src_pm_pgpNetPMEvents.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Mon Jun 10 09:48:00 2013
*/
#include"cobf.h"
#ifdef _WIN32
...
bb160*bb314,bbu bb591,bbu bb944);bbu bb1870(bb307*bbj,bbq bb502);bbb
bb1848(bb307*bbj);bbb bb1960(bb307*bbj);bbu bb1790(bb307*bbj,bb405*
bb625);bbu bb1930(bb307*bbj,bb405*bb625);bbb bb1933(bb33*bbj,bb178
bb104);bbb bb1869(bb33*bbj,bb178 bb104);bbb bb1817(bb33*bbj,bbd bb27,
bbd bb945);
#ifdef UNDER_CE
#define bb1915 64
#endif
...
(bb325*bb796,bb414*bb1614);bbu bb1870(bb307*bbj,bbq bb502){bb32(bbj);
bbj->bb914=bb137(bb502,bb12(bbj->bb914[0 ]));bbm(!bbj->bb914)bb2 0 ;bbj
->bb502=bb502;bb139(&bbj->bb979);bb2 1 ;}bbb bb1848(bb307*bbj){bb32(
bbj);bbm(bbj->bb914){bb109(bbj->bb914);bbj->bb914=bb91;}bbj->bb502=0 ;
bb142(&bbj->bb979);}bbb bb1960(bb307*bbj){bb32(bbj);bb134(&bbj->bb979
);bbj->bb385=0 ;bbj->bb451=0 ;bb132(&bbj->bb979);}bbu bb1790(bb307*bbj,
bb405*bb625){bbu bb26=0 ;bb32(bb625&&bbj);bbm(bbj->bb914&&bb625){bb134
(&bbj->bb979);{bbd bb502=bbj->bb502;bbm(bbj->bb451+1 >bb502){bbj->
bb385=(bbj->bb385+1 )%bb502;bbj->bb451--;}bb81(bbj->bb914+(bbj->bb385+
bbj->bb451++)%bb502,bb625,bb12( *bb625));bb26=1 ;}bb132(&bbj->bb979);}
bb2 bb26;}bbu bb1930(bb307*bbj,bb405*bb625){bbu bb26=0 ;bb32(bb625);
bbm(bbj&&bbj->bb914&&bb625){bb134(&bbj->bb979);bbm(bbj->bb451){bbd
bb502=bbj->bb502;bb81(bb625,bbj->bb914+bbj->bb385,bb12( *bb625));bbj
->bb385=(bbj->bb385+1 )%bb502;bbj->bb451--;bb26=1 ;}bb132(&bbj->bb979);
}bb2 bb26;}bbb bb1933(bb33*bbj,bb178 bb104){bb405 bb97={0 };bb1239*
bb28=(bb1239* )bb97.bb1215;bb97.bb129=bb1357;bb81(bb28->bb104,bb104,
bb12(bb178));bb1790(&bbj->bb1046,&bb97);}bbb bb1869(bb33*bbj,bb178
bb104){bb405 bb97={0 };bb1237*bb28=(bb1237* )bb97.bb1215;bb97.bb129=
bb1325;bb81(bb28->bb104,bb104,bb12(bb178));bb1790(&bbj->bb1046,&bb97);
}bbb bb1817(bb33*bbj,bbd bb27,bbd bb945){bb405 bb97={0 };bb1258*bb28=(
bb1258* )bb97.bb1215;bb97.bb129=bb1359;bb28->bb27=bb27;bb28->bb945=
bb945;bb1790(&bbj->bb1046,&bb97);}
