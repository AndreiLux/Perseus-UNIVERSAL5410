...
void fimc_is_hw_a5_power(struct fimc_is_dev *isp, int on)
{
	...
	if (on) {
		...
		enable_mipi();
		/* set mipi & fimclite */
		f_frame.o_width = DEFAULT_CAPTURE_STILL_WIDTH + 16;
		f_frame.o_height = DEFAULT_CAPTURE_STILL_HEIGHT + 12;
		f_frame.offs_h = 0;
		f_frame.offs_v = 0;
		f_frame.width = DEFAULT_CAPTURE_STILL_WIDTH + 16;
		f_frame.height = DEFAULT_CAPTURE_STILL_HEIGHT + 12;
...
void fimc_is_hw_set_init(struct fimc_is_dev *dev)
{
	...
	case ISS_PREVIEW_STILL:
		...
		IS_SCALERC_SET_PARAM_INPUT_IN_WIDTH(dev,
			init_val_scalerc_preview_still.input_crop.in_width);
		IS_SCALERC_SET_PARAM_INPUT_IN_HEIGHT(dev,
			init_val_scalerc_preview_still.input_crop.in_height);
		IS_SCALERC_SET_PARAM_INPUT_OUT_WIDTH(dev,
			init_val_scalerc_preview_still.input_crop.out_width);
		IS_SCALERC_SET_PARAM_INPUT_OUT_HEIGHT(dev,
		...
		IS_SCALERP_SET_PARAM_INPUT_IN_WIDTH(dev,
			init_val_scalerp_preview_still.input_crop.in_width);
		IS_SCALERP_SET_PARAM_INPUT_IN_HEIGHT(dev,
			init_val_scalerp_preview_still.input_crop.in_height);
		IS_SCALERP_SET_PARAM_INPUT_OUT_WIDTH(dev,
			init_val_scalerp_preview_still.input_crop.out_width);
		IS_SCALERP_SET_PARAM_INPUT_OUT_HEIGHT(dev,
