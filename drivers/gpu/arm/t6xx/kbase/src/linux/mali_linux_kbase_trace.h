...
DEFINE_MALI_REFCOUNT_EVENT(JS_POLICY_KILL_ALL_CTX_JOBS);
...
DEFINE_MALI_ADD_EVENT(PM_HANDLE_EVENT);
DEFINE_MALI_ADD_EVENT(PM_SEND_EVENT);
DEFINE_MALI_ADD_EVENT(PM_ACTIVATE_WORKER);
...
DEFINE_MALI_ADD_EVENT(PM_CORES_CHANGE_DESIRED_ON_POWERUP);
DEFINE_MALI_ADD_EVENT(PM_CORES_CHANGE_DESIRED_ON_POWERDOWN);
...
DEFINE_MALI_ADD_EVENT(PM_CHANGE_POLICY);
