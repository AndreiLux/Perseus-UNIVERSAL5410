 ...
 * - it must \em not hold kbasep_js_device_data::runpool_mutex (as this could be
 obtained internally)
 * - it must \em not hold kbdev->jm_slots_lock (as this could be
 * obtained internally)
 *
 */
 ...
 * - it must hold kbdev->jm_slots_lock
 *
 ...
 * - it must \em not hold kbasep_js_device_data::runpool_irq::lock (as this will be
 * obtained internally)
 * - it must \em not hold kbdev->jm_slots_lock (as this will be
 * obtained internally)
 *
 * @note The caller \em might be holding one of the
 * kbasep_js_kctx_info::ctx::jsctx_mutex locks.
 ...
 * - it must \em not hold kbdev>jm_slots_lock (as this will be obtained
 * internally)
 *
 */
