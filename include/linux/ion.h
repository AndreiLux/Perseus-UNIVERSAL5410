...
#define ION_EXYNOS_VIDEO_MASK		(1 << (BITS_PER_LONG - 3))
#define ION_EXYNOS_MFC_FW_MASK		(1 << (BITS_PER_LONG - 4))
#define ION_EXYNOS_SECTBL_MASK		(1 << (BITS_PER_LONG - 5))
#define ION_HEAP_EXYNOS_MFC_SH_MASK					\
		(ION_HEAP_EXYNOS_CONTIG_MASK|ION_EXYNOS_MFC_SH_MASK)
#define ION_HEAP_EXYNOS_VIDEO_MASK					\
		(ION_HEAP_EXYNOS_CONTIG_MASK|ION_EXYNOS_VIDEO_MASK)
