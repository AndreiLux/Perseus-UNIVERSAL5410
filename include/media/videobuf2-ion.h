...
struct scatterlist *vb2_ion_get_sg(struct vb2_buffer *vb,
				   unsigned int plane_no, int *nents);

static inline unsigned long vb2_ion_plane_dvaddr(struct vb2_buffer *vb,
						 unsigned int plane_no)
{
	return (unsigned long)vb2_plane_cookie(vb, plane_no);
}

static inline unsigned long vb2_ion_plane_kvaddr(struct vb2_buffer *vb,
						 unsigned int plane_no)
{
...
void **vb2_ion_init_multi(unsigned int num_planes, struct vb2_ion *ion,
			  struct vb2_drv *drv);
